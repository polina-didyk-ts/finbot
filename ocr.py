...
def extract_amount(image_path: str) -> str:
    ...
    try:
        ...
        prompt = (
            ...
            "Витягни суму операції/платежу/покупки (не комісію, не код авторизації, "
            "не номер картки чи рахунку). "
            "Якщо це банківська квитанція — бери поле 'Сума' транзакції, ігноруючи "
            "комісію. "
